Pod::Spec.new do |s|
    ...
    s.source       = {:git => 'https://github.com/khanghoang/KHTableViewController.git', :tag => '0.1.5'}
    s.source_files = "KHTableViewController/Classes/*", "KHTableViewController/Classes/**/*"
